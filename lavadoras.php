...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Kanit:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900&family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900&display=swap"
        rel="stylesheet">
...
<body>
    <header>
        ...
        <div id="tituloTexto">
            <h1>Nuestros recomendados para lavadoras</h1>
        </div>
    </header>
    <div class="container">
        <div id="reseñas" class="mt-4">
            <?php
            $instruccion_sql = "SELECT * FROM recomendaciones WHERE especialidad = 3";
                ...
                while($row = $resultado->fetch_array()){
                    ...
                    <div class="card" id="reseñas">
                        ...
                        <div class="card-footer">
                            ...
                            <form action="lavadoras.php" method="post" style="display: inline;">
