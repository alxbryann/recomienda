    ...
    <main>
        ...
        <div class="container-recomendaciones">
            ...
            <?php
                ...
                echo '<a href="#" class="dropdown-toggle" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color: white;">Ver recomendaciones del perfil</a>';
